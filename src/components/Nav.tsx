      ...
      <div className="container mx-auto px-4 h-full">
        <div className="flex justify-between items-center h-full ">
          ...
          <div className=" flex justify-center items-center  "> 
            <Link href="/" className=" text-2xl font-bold bg-blue-600 rounded-xl text-white p-2">TicketHub</Link>            
          </div>
          ...
          <ul className={`md:flex text-center items-center justify-center gap-6 text-white ${open ? "flex flex-col absolute top-20 right-0 bg-cyan-500 w-full p-4" : "hidden md:flex"}`}>
            <li>
              <Link href="/" passHref>
                <p className={`px-2 ${pathname === "/" ? "underline" : "hover:underline"}`}>Home</p>
              </Link>
            </li>
            
            <li>
              <Link href="/events" passHref>
                <p className={`px-2 ${pathname === "/events" ? "underline" : "hover:underline"}`}>Events</p>
              </Link>
            </li>
            
            <li>
              <Link href="/about" passHref>
                <p className={`px-2 ${pathname === "/about" ? "underline" : "hover:underline"}`}>About Us</p>
              </Link>
            </li>
